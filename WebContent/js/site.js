...
Gallery.prototype = {
	...
	positionContact : function(i, item) {
		...
		var top = (rowIndex / this.CONTACTS_PER_COL) * 100 + 2.5 + "%";
		var left = (relPage + colIndex / this.CONTACTS_PER_ROW) * 100 + 2.5
				+ "%";
	...
	positionSlide : function(i, item) {
		var $item = $(item);
		var relIndex = i - this.activeIndex;
		var left = 100 * relIndex + "%";
